...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Gudang Dika</a>
            <!-- Sidebar Toggle-->
                                    ...
                                    <?php 
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <input type="text" name="penerima" value="<?=$penerima;?>" placeholder="Nama Barang" class="form-control" required>
                                                <br>
